...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gqj7yiq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gqj7yiq.containers.anotherwebservice.com/
...
```
git clone git@github.com:Jaykidd1o1/container-gqj7yiq.git
cd container-gqj7yiq
```
...
```
docker attach container-gqj7yiq
```
